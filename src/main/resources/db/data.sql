...
insert into transaction_tb(goods_id, buyer_id, seller_id, buyer_status, seller_status, transaction_status, success_price, updated_at) values (7, 1, 3, 0, 0, 0,9200, now());
